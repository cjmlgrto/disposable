...
struct HeaderInnerShadow<S: Shape>: View {
    var shape: S
...
struct HeaderContainerStyle: ViewModifier {
...
public extension View {
    func headerContainerStyle(cornerRadius: CGFloat = 24) -> some View {
        modifier(HeaderContainerStyle(cornerRadius: cornerRadius))
    }
}
...
#Preview {
    ...
    .padding()
    .headerContainerStyle(cornerRadius: 24)
    .padding()
